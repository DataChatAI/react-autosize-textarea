...
var TextareaAutosize = /** @class */ (function (_super) {
    ...
    function TextareaAutosize() {
        ...
        _this.getLocals = function () {
            var _a = _this, _b = _a.props, onResize = _b.onResize, maxRows = _b.maxRows, onChange = _b.onChange, style = _b.style, props = __rest(_b, ["onResize", "maxRows", "onChange", "style"]), lineHeight = _a.state.lineHeight, saveDOMNodeRef = _a.saveDOMNodeRef;
